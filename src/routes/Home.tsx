      ...
      <div className="xl:w-1/2 md:w-1/2 xsm:w-full flex flex-col gap-4">
        <div>
          <h1 className="font-bold text-3xl">
            Hello👋, I'm <span className='text-[#2B2D42] dark:text-[#A8DADC]'>Adarsh Kumar</span> and
          </h1>
        ...
        <div className="flex xl:gap-8 xsm:justify-between xl:justify-normal">
          ...
          <a href="https://linkedin.com/in/adarsh-kumar-7b550a1aa" target="_blank">
            <button className="btn btn-circle">
        ...
        <button className='bg-[#E63946] text-[#F1FAEE] p-2 w-1/3 rounded-md font-semibold shadow-sm shadow-inherit'><Link to="/about">More about me -&gt;</Link></button>
      </div>
      <div className="xl:w-1/2 md:w-1/2 xsm:w-full flex md:justify-end xsm:mb-4 md:mb-0">
        <img src={profilePic} alt="" className="md:w-3/4 rounded-xl shadow-md shadow-slate-500" />
      </div>
