...
export default function Projects() {
  const list = projects.map((pr) => (
    <div className="bg-[#F0f4ef] grid gap-y-5 border border-[#03001C33] dark:border:[#fff] px-5 py-3 rounded-md shadow-md shadow-[#03001C]">
      <div>
        <img src={pr.img} className="border border-[#03001C22] rounded-md transition ease-in-out delay-150 hover:translate-y-1 hover:scale-105 duration-300" />
      </div>
      <div className="p-2">
